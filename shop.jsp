...
<!--     Any body here? -->
    ...
    <head>
        ...
        <!-- Site Metas -->
        <title>Nhà xuất bản Duy Khánh</title>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                        <div class="why-text full-width">
                                                            ...
                                                            <p>${p.description}</p>
                                                            <c:if test="${sessionScope.acc.isadmin == 0 || sessionScope.acc == null}">
                                                                <a class="btn hvr-hover" href="detail?pid=${p.id}">Add to Cart</a>
                                                            </c:if>
                                                            <c:if test="${sessionScope.acc.isadmin == 1}">
                                                                <a class="btn hvr-hover" href="">Chỉnh sửa</a>
                                                            </c:if>
                                                        </div>
                                                    </div>
                                                </div>
